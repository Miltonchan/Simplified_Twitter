...
db.once('open', () => {
    ...
    Userinfo.create({
        ...
        username:'Kirito',
        nickname:'Beater',
        icon:'data:image/jpeg;base64,/9j/2wCEAAgGBgcGBQgHBwcJCQg…3B7G4TnBAHoeKVPKVeYwf8/WljG6MMep/+tTtoyeO9dRyn//Z',
        private: false,
    ...
    Userinfo.create({
        ...
        username:'Eugeo',
        nickname:'Donald',
        icon:'data:image/jpeg;base64,/9j/4AAQSkZJRgABAQEASABIAAD…KNDbvMw+F/J5+sp5gNo7BEKXX4gW6VBWFOzzMqFbTPSf/2Q==',
        private: false,
        follower: ['Asuna'],
